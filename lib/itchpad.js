...
var Itchpad = Class({
  ...
  onLoad: function() {
    ...
    this.win.addEventListener("unload", this.destroy.bind(this));
  ...
  // FIXME: this is copied from itchpad-window.js
  goUpdateSourceEditorMenuItems: function() {
